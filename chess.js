...
class Game {
    ...
    tryMove({from, to}) {
      ...
      } else if (piece instanceof King && from.col - to.col === 2) {
        this.tryCastle(piece.colour, QUEENSIDE);
      } else {
        this.tryNonCastlingMove(from, to);
      }
    }
    generateFEN() {
        let FEN = "";
...
module.exports.QUEENSIDE = QUEENSIDE;
module.exports.KINGSIDE = KINGSIDE;
module.exports.oppositeColour = oppositeColour;
module.exports.oppositeSide = oppositeSide;
...
module.exports.InvalidMoveError = InvalidMoveError;
